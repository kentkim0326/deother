...
**남은 것**
- [ ] **태국 게임쇼 부스 사진 3장** — `assets/tgs-01.jpg` · `tgs-02.jpg` · `tgs-03.jpg`.
      코드는 다 들어가 있고 **파일만 넣으면 바로 뜬다**(없으면 조용히 숨는다).
      캡션(`journey.photos`)은 지금 연표의 사실만 일반적으로 쓴 것이라, 실제 사진에 맞게 고칠 것.
