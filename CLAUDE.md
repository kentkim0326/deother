...
> 주식회사 디아더와 게임 9종을 소개하는 정적 사이트. 빌드 도구 없이 HTML/CSS/JS 파일만으로 동작한다.
...
- **게임 9종** 카드 + 로고 + SNS 링크
- **상세 페이지 8종** (밀리버스 · 킹덤워즈 · 장보고 · KWO · 숨바 · 저승사자 · 타임 워즈 · 터프 킹)
  - 밀리버스·킹덤워즈·장보고·KWO 는 10개 언어, **숨바·저승사자·타임워즈·터프킹은 우선 ko/en**
    (카드는 9종 모두 10개 언어)
...
- [ ] **숨바·저승사자·타임워즈·터프킹 상세 10개 언어 확장** (지금 ko/en). 카드는 이미 10개 언어다.
...
```
메인          카드 9장 · 상세 링크 8개(…/soomba/deathguide/timewars/turfking)
상세          앞 4종 10개 언어(구조 일치·한글 누출 0), 숨바·저승사자·타임워즈·터프킹 ko/en
