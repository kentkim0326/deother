...
- **보류: "데니스 리치 교수에게 CS50 을 들었다"** — 대표님은 리치가 CS50 을 가르쳤다고 하신다
  (2026-08-14). 그런데 확인해 보면 CS50 은 1989년에 처음 개설됐고 2007년부터 David Malan 이
  맡고 있으며, 리치는 1960년대 초 대학원생 시절 하버드 입문 프로그래밍 과목의 teaching fellow 를
  했을 뿐 1967년부터 벨연구소에 있었다(2011년 작고). 연도가 맞물리지 않아 **아직 안 넣었다.**
  대표님이 다시 확인해 주시면 그때 넣는다. 지금은 "컴퓨터 공학 수업을 들었다"까지만.
...
- [ ] **하버드 입학 연차 확정** — 문서는 3년, team bullet 은 3년 반. 아직 founder 페이지엔 안 썼다.
- [ ] **데니스 리치 / CS50** — 위 「⚠️ 대표 소개」 3항. 대표님 재확인 대기 중.
