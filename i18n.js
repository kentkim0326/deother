...
const JOURNEY_LINKS = [
  ...
  "",                              // Pocket Gamer Connects Korea — 회차별이라 상시 주소 없음
...
// ⚠️ 이 페이지는 8,300자에 목록만 73항목이라 **가장 글벽이 되기 쉬운 곳**이다.
//    섹션 11개 전부 뒤에 사진이 한 장씩 붙도록 열두 장을 둔다(P_LAYOUT.festivals).
//    사진을 빼면 그만큼 글벽이 늘어난다 — 뺄 거면 대신 넣을 것을 먼저 정한다.
...
const FOUNDER_SLIDES = [
  ...
  "founder-docs/doc-17.jpg", "founder-docs/doc-18.jpg",
];
...
const WORKS = [
  ...
  { key: "turfking", dev: true, url: "https://deother.itch.io/turf-king",     tag: "2026",
