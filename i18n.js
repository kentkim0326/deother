...
const MV_SLIDES = [];   // assets/slides-mv/ — 밀리버스 상세 페이지에서 쓴다
...
const I18N = {
  en: {
    ...
    works: { more: "Read more", heading: "What we have built", lead: "Three games built and live. And the IP behind them — novels and web serials — is written in-house.", items: {
  ...
  ko: {
    ...
    works: { more: "자세히", heading: "우리가 만든 것", lead: "게임 세 개를 만들어 띄웠습니다. 그 바탕이 되는 IP — 소설·웹소설 — 도 직접 씁니다.", items: {
  ...
  zh: {
    ...
    works: { more: "了解更多", heading: "我们做出来的东西", lead: "三款游戏，都已上线。支撑它们的 IP——小说与网络连载——也全部自己创作。", items: {
  ...
  ja: {
    ...
    works: { more: "詳しく", heading: "作ってきたもの", lead: "三本のゲームを作り、世に出しました。その土台となるIP——小説とウェブ小説——も自分たちで書いています。", items: {
  ...
  es: {
    ...
    works: { more: "Saber más", heading: "Lo que hemos construido", lead: "Tres juegos construidos y en línea. Y la IP que hay detrás —novelas y seriales— la escribimos nosotros.", items: {
  ...
  pt: {
    ...
    works: { more: "Saber mais", heading: "O que construímos", lead: "Três jogos construídos e no ar. E a IP por trás deles — romances e séries web — é escrita internamente.", items: {
  ...
  fr: {
    ...
    works: { more: "En savoir plus", heading: "Ce que nous avons construit", lead: "Trois jeux construits et en ligne. Et la propriété intellectuelle qui les porte — romans et feuilletons — est écrite en interne.", items: {
  ...
  de: {
    ...
    works: { more: "Mehr erfahren", heading: "Was wir gebaut haben", lead: "Drei Spiele gebaut und online. Und die IP dahinter — Romane und Web-Serials — schreiben wir selbst.", items: {
  ...
  ru: {
    ...
    works: { more: "Подробнее", heading: "Что мы построили", lead: "Три игры сделаны и работают. И IP за ними — романы и веб-сериалы — мы пишем сами.", items: {
  ...
  ar: {
    ...
    works: { more: "اقرأ المزيد", heading: "ما بنيناه", lead: "ثلاث ألعاب مبنية وتعمل. والملكية الفكرية خلفها — روايات وسلاسل إلكترونية — نكتبها بأنفسنا.", items: {
