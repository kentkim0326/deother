...
const IP_COVERS = ["ip-00.jpg", "ip-01.jpg", "ip-02.jpg", "ip-03.jpg", "ip-04.jpg", "ip-05.jpg", "ip-06.jpg", "ip-07.jpg", "ip-08.jpg", "ip-11.jpg", "ip-12.jpg", "ip-13.jpg"];   // assets/covers/ — .\add-slides.ps1 ip 가 채운다
// 표지에 제목이 이미 박혀 있으므로 번역하지 않고 원제를 쓴다. 순서는 IP_COVERS 와 같다.
const IP_TITLES = ["Seraphim — Fighting Nations 원작", "훈민정음", "판문점", "조선늑대", "저승사자", "장보고", "아리랑전사단", "총기허용의 날", "문신귀", "전원주택", "Ring of Solomon: Dino Wars", "Kingdom Wars"];
